...
// GÖNDERDİĞİN 49 RESİMLİK LİSTENİN TAMAMI (SOL VE SAĞ DUVARLAR)
const ARTWORKS = [
  // --- SOL DUVAR (X = -11.88) ---
  ...
  // --- ÖN DUVAR (Z = 14.0 - TEKİL ESERLER) ---
  { id: 17, title: 'Azure Solitude', file: '/artworks/17-flower07-11-23.png', position: [-9.0, 1.8, 14.0], rotation: [0, Math.PI, 0], height: 1.2 },
  { id: 18, title: 'Mediterranean Reverie', file: '/artworks/18-bycycle1.jpg', position: [-5.4, 1.8, 14.0], rotation: [0, Math.PI, 0], height: 1.2 },
  { id: 19, title: 'Gilded Sunflower', file: '/artworks/19-sunflower2.jpg', position: [-1.8, 1.8, 14.0], rotation: [0, Math.PI, 0], height: 1.2 },
  { id: 20, title: 'Iris at Twilight', file: '/artworks/20-DSC00927.JPG', position: [1.8, 1.8, 14.0], rotation: [0, Math.PI, 0], height: 1.2 },
  { id: 23, title: 'Red Poppy I', file: '/artworks/23poppy1.jpg', position: [5.4, 1.8, 14.0], rotation: [0, Math.PI, 0], height: 1.2 },
  { id: 24, title: 'Red Poppy II', file: '/artworks/24poppy2.jpg', position: [9.0, 1.8, 14.0], rotation: [0, Math.PI, 0], height: 1.2 }
];

// 4'LÜ SETLER (2x2 KARE BLOKLAR - ARKA DUVARDA)
const GRID_SETS = [
  {
    id: 'flamingo-set',
